package com.example.sprinthub.retrofitgithub;
...
import com.example.sprinthub.retrofitgithub.models.GithubIssue;
import com.example.sprinthub.retrofitgithub.models.GithubRepo;
...
public class MainActivity extends AppCompatActivity implements CredentialsDialog.ICredentialsDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repositoriesSpinner.setAdapter(new ArrayAdapter<>
        ...
        issuesSpinner.setAdapter(new ArrayAdapter<>(
                MainActivity.this, android.R.layout.simple_spinner_dropdown_item,
